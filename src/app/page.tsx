  ...
  return (
    <main className="flex-1">
      ...
      <section className="mx-auto max-w-5xl px-6 pt-12 pb-16 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-black leading-tight max-w-2xl mx-auto">
          Mau ngapain bersama anak-anak hari ini?
        </h1>
        <p className="text-lg text-ink-muted mt-5 max-w-xl mx-auto">
      ...
      <section className="mx-auto max-w-5xl px-6 pb-20">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {FEATURES.map((f) => (
            <div key={f.title} className="bg-surface border border-line rounded-(--radius-card) p-6">
      ...
      <section className="bg-primary-soft">
        <div className="mx-auto max-w-3xl px-6 py-14 text-center">
          <h2 className="text-2xl font-black">Aman untuk anak, ramah untuk guru</h2>
      ...
      <footer className="mx-auto max-w-5xl px-6 py-8 text-sm text-ink-muted flex flex-wrap justify-between gap-3">
